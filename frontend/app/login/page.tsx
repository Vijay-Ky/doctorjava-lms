        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-5 rounded-3xl border border-slate-200 bg-white p-7 shadow-soft">
            ...
            <p className="text-center text-[11px] text-slate-400">
              Social login requires <code className="rounded bg-slate-100 px-1">GOOGLE_CLIENT_ID</code> /{' '}
              <code className="rounded bg-slate-100 px-1">FACEBOOK_CLIENT_ID</code> and profile{' '}
              <code className="rounded bg-slate-100 px-1">oauth</code>. See application-oauth.yml.
            </p>
          </div>
        </div>
      </main>
